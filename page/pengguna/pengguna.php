                    ...
                    <div class="box box-primary box-solid">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <a href="?page=pengguna&aksi=tambah" class="btn btn-success" style="margin-bottom:  8px;"><i class="fa fa-plus"></i> Tambah </a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if ($data['level']== "admin") { ?>
                                                    <a disabled="" class="btn btn-danger " ><i class="fa fa-trash "></i> Hapus</a> 
                                                <?php }else{ ?>
