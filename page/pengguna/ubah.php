    ...
    $lokasi = $_FILES['foto']['tmp_name'];
 	...
 	if ($simpan) {
        ...
        $upload = move_uploaded_file($lokasi, "images/".$foto);
 		...
 		$sql = $koneksi->query("update  tb_user set username='$username',password='$pass',  nama_user='$nama', foto='$foto' where id='$id'");
        ...
        $sql = $koneksi->query("update  tb_user set username='$username',password='$pass', nama_user='$nama' where id='$id'");
